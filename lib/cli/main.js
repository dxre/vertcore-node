...
var vertcorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = vertcorenode.version;
  var create = vertcorenode.scaffold.create;
  var add = vertcorenode.scaffold.add;
  var start = vertcorenode.scaffold.start;
  var remove = vertcorenode.scaffold.remove;
  var callMethod = vertcorenode.scaffold.callMethod;
  var findConfig = vertcorenode.scaffold.findConfig;
  var defaultConfig = vertcorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('    $ vertcore-node remove insight-api');
      console.log();
    });
